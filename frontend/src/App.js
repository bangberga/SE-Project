      ...
      <div class="brand">
        <button onclick="openMenu()">
          &#9776;
            ...
            <a href="index.html" class="btn btn-white btn-animate">SHOP FRUIT</a>
      </div>
        ...
        <ul class="products">
          <li>
            <div class="product">
              ...
              <div class="product-brand">Vietnam</div>
          ...
          <li>
            <div class="product">
              <img class="product-image" src="/template/imges/pd2.jpg" alt="product" />
              <div class="product-name">
